...
Оно отображает график изменения параметра по данным из текстового файла заданного формата ([см. ниже](#формат-файла-телеметрии)).
Имеется поддержка интерактивного масштабирования и панорамирования графика
...
Данный проект распространяется под лицензией GNU GPLv3.
